<%@ Page Title="Student Payment" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StudentPayment.aspx.cs" Inherits="ADbSD_Coursework_I.WebForm7" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <div class="form-group mb-2">
            <asp:Button ID="submitTeacherModuleBTN" runat="server" Text="Submit" CssClass="btn btn-primary" OnClick="submitStudentPaymentBTN_Click"/>
